...
describe("CopyrightWarningModal", () => {
  ...
  it("renders with warning level correctly", () => {
    ...
    expect(
      screen.getByText("Spider-Man is a trademarked character owned by Marvel/Disney."),
    ).toBeInTheDocument();
  });
  ...
  it("displays disclaimer text", () => {
    ...
    expect(
      screen.getByText(/By continuing, you acknowledge potential copyright or trademark concerns/i),
    ).toBeInTheDocument();
  });
