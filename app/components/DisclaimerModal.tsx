...
const DisclaimerModal: React.FC<DisclaimerModalProps> = ({ show, onClose }) => (
  ...
  >
    <p className={styles.disclaimerText}>
      This chatbot is for entertainment purposes only. No information provided should be considered
      professional, legal, medical, or financial advice. Content may be generated by artificial
      intelligence and may contain inaccuracies or limitations. Use at your own risk. The creators
      disclaim all liability for actions taken based on chatbot interactions.
    </p>
  </DisclaimerStyleModal>
);
