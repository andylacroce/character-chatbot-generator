/**
 * Entry point component for the Portrayal application.
...
import { getValidBotFromStorage, clearStoredBot } from "../utils/getValidBotFromStorage";
...
const Home = () => {
  ...
  const handleBotCreated = React.useCallback(
    (bot: Bot) => {
      setBot(bot);
