...
- **Not yet done:** Phase 2's leaderboard (see "Phasing" above) hasn't been started at all — no schema changes, no `/leaderboard` page. Tracked in [GitHub issue #876](https://github.com/andylacroce/character-chatbot-generator/issues/876), alongside Phase 3.
